...
ActiveRecord::Schema.define(version: 20150811080749) do
  ...
  add_index "data_source_account_permissions", ["accessed_id"], name: "index_data_source_account_permissions_on_accessed_id", using: :btree
  add_index "data_source_account_permissions", ["data_source_account_id"], name: "index_data_source_account_permissions_on_data_source_account_id", using: :btree
  ...
  add_index "data_source_accounts", ["data_source_id"], name: "index_data_source_accounts_on_data_source_id", using: :btree
  add_index "data_source_accounts", ["owner_id"], name: "index_data_source_accounts_on_owner_id", using: :btree
  ...
  add_index "databases", ["deleted_at", "id"], name: "index_databases_on_deleted_at_and_id", using: :btree
  ...
  add_index "datasets", ["schema_id"], name: "index_datasets_on_schema_id", using: :btree
  ...
  add_index "hdfs_entries", ["hdfs_data_source_id", "path"], name: "index_hdfs_entries_on_hdfs_data_source_id_and_path", unique: true, using: :btree
  ...
  create_table "running_workfiles", force: true do |t|
    t.integer  "owner_id"
    t.integer  "workfile_id"
    t.text     "killable_id"
    t.datetime "deleted_at"
  ...
  add_index "schemas", ["parent_id"], name: "index_schemas_on_parent_id", using: :btree
  ...
  create_table "worklet_parameter_versions", force: true do |t|
    t.integer  "worklet_parameter_id"
    t.integer  "owner_id"
    t.text     "value"
    t.integer  "event_id"
    t.text     "result_id"
  ...
  create_table "worklet_parameters", force: true do |t|
    t.integer  "workfile_id"
