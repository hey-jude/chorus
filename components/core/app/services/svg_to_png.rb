require Core::Engine.root + 'vendor/batik-all-1.7.jar'
require Core::Engine.root + 'vendor/xml-apis-ext-1.3.04.jar'
...
class SvgToPng
  ...
  def initialize(svg_content)
    ...
    transcoder.addTranscodingHint(transcoder_class::KEY_USER_STYLESHEET_URI, "file://" + Core::Engine.root.join("public/assets/visualizations.css").to_s)
