class BaseSchema < ActiveRecord::Migration
  ...
  # This "BaseSchema" is the sum of all migrations prior to the 5.x releases.
  # It incorporates all migrations up to: 20140922061144_add_options_to_dashboard_items.rb
  #
  # In the Chorus Upgrade Guide: https://alpine.atlassian.net/wiki/display/CD5/Upgrade+Chorus+to+5.x
  # ... the instructions state that you must upgrade linearly through each major number version.
  # That is, from 3.x -> 4.0 -> 5.0 -> 5.x ... this strategy supports that.  However, you cannot upgrade from
  # 4.x directly to 5.8.
