    ...
    updateChiasmVisualization: function(){
        ...
        this.chiasmInit(dataset_id, function (chiasm, columns){
            ...
            if(chartType === "frequency"){
                ...
                chiasm.setConfig(generateBarChartConfig(params_frequency));
                ...
                chiasm.setConfig(generateHeatMapConfig(params_heatmap));
                ...
                chiasm.setConfig(generateBoxPlotConfig(params_boxplot));
            } else if(chartType === "timeseries") {
                //console.log("here");
                //console.log(chartOptions);
                var params_timeseries = {
                    xColumn: {
                        name: chartOptions.xAxis,
                        label: chartOptions.xAxis,
                        type: "date"
                ...
                chiasm.setConfig(generateLineChartConfig(params_timeseries));
            } else {
                //chiasm.setConfig({});
            }
        });
