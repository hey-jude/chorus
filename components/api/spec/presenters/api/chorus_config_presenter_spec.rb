...
describe Api::ChorusConfigPresenter, :type => :view do
  ...
  let(:presenter) { Api::ChorusConfigPresenter.new(config, view, {}) }
  ...
  describe "present" do
    ...
    it 'presents the license' do
      hash[:license].should == (Api::LicensePresenter.new(License.instance, view).presentation_hash)
    end
