    ...
    describe("#fetch", function () {
        describe("without filtering", function () {
            it("creates the right URL", function () {
                expect(this.collection.url()).toBe("/workspaces/1234/workfiles?no_published_worklets=true&page=1&per_page=20");
            });
        });
        describe("with filtering", function () {
            ...
            it("it has correct Url", function () {
                expect(this.collection.url()).toBe("/workspaces/1234/workfiles?file_type=sql&no_published_worklets=true&page=1&per_page=20");
            });
        });
        describe("with sorting", function () {
            ...
            it("it has correct Url", function () {
                expect(this.collection.url()).toBe("/workspaces/1234/workfiles?file_type=sql&no_published_worklets=true&page=1&per_page=20&order=name");
            });
        });
    });
